      ...
      <section className="mx-auto max-w-7xl px-6 pb-16 pt-20 md:px-10 md:pb-20 md:pt-44">
        <FadeUp>
          <div className="mx-auto max-w-6xl text-center">
            ...
            <h2 className="text-metal mx-auto mt-8 max-w-5xl font-serif text-3xl leading-tight tracking-[0.04em] text-white [line-break:strict] [word-break:keep-all] md:text-[clamp(1.9rem,5.4vw,5.8rem)] md:tracking-[0.08em]">
