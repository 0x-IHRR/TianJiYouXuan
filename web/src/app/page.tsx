        ...
        <div className="flex w-full flex-nowrap gap-4 overflow-x-auto snap-x snap-mandatory px-4 pb-8 [scrollbar-width:none] md:mx-auto md:h-[70vh] md:max-w-7xl md:flex-row md:gap-4 md:overflow-visible md:px-6">
          {entrances.map((item) => (
            <Link
              key={item.href}
              href={item.href}
              className="group relative h-[65vh] w-[82vw] snap-center shrink-0 overflow-hidden rounded-[2rem] transition-[flex-grow] duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] md:h-full md:w-auto md:flex-1 md:hover:flex-[2.5] md:focus-visible:flex-[2.5]"
