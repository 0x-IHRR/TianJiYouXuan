  ...
  return (
    <main className="overflow-hidden bg-[#0a0a0a]">
      ...
      <section className="flex min-h-[62vh] items-center justify-center bg-black px-6 py-16 md:min-h-[100dvh] md:py-28">
        <AnimatedText
          text={"我们不是普通消费者，\n我们是新时代的觉醒者。"}
          className="text-metal mx-auto max-w-6xl text-center font-serif text-3xl leading-[1.35] tracking-[0.14em] text-white text-balance md:text-[clamp(1.9rem,5.4vw,5.7rem)] md:leading-[1.22] md:tracking-[0.18em]"
        />
      </section>
