  ...
  return (
    <main className="overflow-hidden bg-[#0a0a0a]">
      <section className="relative flex min-h-[82vh] items-end overflow-hidden px-6 pb-20 pt-24 md:min-h-[92vh] md:px-10 md:pb-28 md:pt-32">
        ...
        <div className="pointer-events-none absolute right-4 top-28 font-display text-[5.5rem] leading-none text-white/[0.035] md:right-0 md:text-[13rem]">
          1/10000
        </div>
      ...
      <section className="flex min-h-[56vh] items-center justify-center bg-[#0a0a0a] px-6 py-16 md:min-h-[70vh] md:py-24">
        <FadeUp>
          <h2 className="mx-auto max-w-6xl text-center font-serif text-3xl leading-[1.45] tracking-[0.14em] text-white [line-break:strict] [word-break:keep-all] md:text-[clamp(1.8rem,4.4vw,4.6rem)] md:leading-[1.28] md:tracking-[0.18em]">
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 md:px-10 md:py-44">
        <FadeUp>
          <div className="mx-auto max-w-5xl text-center">
            ...
            <h2 className="text-metal mx-auto mt-8 max-w-5xl font-serif text-3xl leading-tight text-white md:text-[clamp(2rem,5.2vw,5.8rem)] md:whitespace-nowrap">
              不增加选择
        ...
        <div className="mx-auto mt-16 max-w-5xl space-y-8 md:mt-24">
          {curationSignals.map((signal, index) => (
            <FadeUp key={signal.title} delay={index * 0.08}>
              <TiltCard
                className="liquid-glass-strong rounded-[1.75rem] p-7 md:p-10"
                innerClassName="grid gap-8 md:grid-cols-[9rem_1fr] md:items-end"
              >
                <span className="font-display text-5xl leading-none text-white/12 md:text-7xl">
                  {signal.number}
                </span>
                <div>
                  <h3 className="max-w-md font-serif text-2xl leading-tight text-white [word-break:keep-all] md:whitespace-nowrap md:text-4xl">
                    {signal.title}
                  </h3>
              ...
              <FadeUp key={tier.value} delay={index * 0.08}>
                <TiltCard className="liquid-glass group relative overflow-hidden rounded-[2rem] p-8 md:p-10">
                  ...
                  <div className="relative z-10 grid gap-8 md:grid-cols-[16rem_1fr] md:items-end">
                    ...
                    <div>
                      <h3 className="font-serif text-3xl leading-tight text-white [word-break:keep-all] md:whitespace-nowrap">
                        {tier.label}
                      </h3>
                      <p className="mt-6 max-w-xl text-sm leading-loose text-white/58 text-pretty">
                        {tier.body}
                      </p>
                    </div>
                  </div>
