...
export default function EventsPage() {
  return (
    <main className="overflow-hidden bg-[#0a0a0a]">
                ...
                return (
                  <FadeUp key={event.english} delay={index * 0.05}>
                    ...
                    >
                      ...
                      <TiltCard
                        className={`liquid-glass-strong group relative col-start-2 min-h-[20rem] overflow-hidden rounded-[2rem] p-7 transition-colors duration-700 hover:bg-white/[0.055] md:p-9 ${
                      ...
                      >
                        <div className="flex flex-col gap-7 md:flex-row md:items-start md:justify-between">
                          ...
                          <span className="w-fit rounded-full border border-white/15 bg-white/[0.045] px-5 py-2.5 font-display text-[10px] uppercase tracking-[0.32em] text-white/70 shadow-[0_0_0_rgba(255,255,255,0)] transition-all duration-500 group-hover:border-[hsl(var(--accent))]/45 group-hover:bg-white/[0.075] group-hover:text-white group-hover:shadow-[0_0_22px_rgba(212,175,55,0.16)]">
                            SIGN UP / 报名中
                          </span>
                        </div>
      ...
      <section className="flex min-h-[68vh] items-center justify-center bg-black px-6 py-24">
        <AnimatedText
